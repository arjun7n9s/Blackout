...
object FieldLayout {
    ...
    private val LABEL_LEXICON = setOf(
        ...
        "mobile", "mobile no", "phone", "phone no", "telephone", "contact", "contact no",
        "registered mobile", "email", "email id", "e-mail",
        ...
        "employee id", "employee name", "emp id", "designation", "department",
